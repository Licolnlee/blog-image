# Licolnlee's blog 的图床 (临时)

临时作为 [Licolnlee 的个人博客](https://licolnlee.icu)的图床，直到我有钱去买更好的图床

本仓库与[博客](https://github.com/Licolnlee/blog-source)一样采用 [CC BY-NC-SA 4.0 License](https://creativecommons.org/licenses/by-nc-sa/4.0/)
